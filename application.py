...
FEATURE_NAMES = ['Pclass','Sex', 'Age','Fare','Embarked','FamilySize', 'Isalone','HasCabin', 'Title', 'Pclass_Fare', 'Age_Fare']
...
def predict():
    try:
        ...
        features = pd.DataFrame([[Pclass,Sex, Age,Fare,Embarked,FamilySize, Isalone,HasCabin, Title, Pclass_Fare, Age_Fare]], columns=FEATURE_NAMES)
